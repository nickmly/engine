...
void MainMenu::onStart()
{
	...
	images.push_back("assets/textures/Right_MauveSpaceBox.png");
	images.push_back("assets/textures/Left_MauveSpaceBox.png");
	images.push_back("assets/textures/Up_MauveSpaceBox.png");
	images.push_back("assets/textures/Down_MauveSpaceBox.png");
	images.push_back("assets/textures/Back_MauveSpaceBox.png");
	images.push_back("assets/textures/Front_MauveSpaceBox.png");
